...
The local dashboard overview is available at `/dashboard.html`, and provider
management is available at `/providers.html`. Both use preview data until the
gateway API is connected.
